  ...
  >
    <div class="mt-25 flex w-full max-w-[40em] items-center justify-center lg:mt-34">
      ...
      >
        ...
        >
          <img alt="Nuxt logo" class="h-14 w-14" height="{56}" src="" width="{56}"/>
        </div>
      </div>
      <div
    ...
    <div class="grid grid-rows-3 gap-7 lg:grid-cols-3 lg:grid-rows-none">
      ...
      <a href="https://cloud.appwrite.io" rel="noopener noreferrer" target="_blank">
        <div
      ...
      <a href="https://appwrite.io/docs" rel="noopener noreferrer" target="_blank">
        <div
          class="flex h-full w-72 flex-col gap-2 rounded-md border border-[#EDEDF0] bg-white p-4"
        >
          <div class="flex flex-row items-center justify-between">
    ...
    <aside class="fixed bottom-0 flex w-full cursor-pointer border-t border-[#EDEDF0] bg-white">
      <details ref="detailsRef" :open="showLogs" class="w-full">
        <summary
        ...
        >
          ...
          <div class="icon">
            <span aria-hidden="true" class="icon-cheveron-down"></span>
          </div>
        </summary>
